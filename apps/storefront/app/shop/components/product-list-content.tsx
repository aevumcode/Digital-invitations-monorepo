...
export function ProductListContent({ products, collections }: ProductListContentProps) {
  ...
  // For now: no extra client-side filters (colors, sizes, etc.)
  // Later: you can add filters based on schemaJson fields or tags
  ...
  return (
    <>
      ...
      {products.length > 0 ? (
        ...
        <Card className="flex mr-sides flex-1 items-center justify-center">
          <p className="text text-muted-foreground font-medium">No invitations found</p>
        </Card>
      )}
    </>
  );
