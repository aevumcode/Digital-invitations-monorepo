...
export default function TemplateTestPage({ params }: { params: { slug: string } }) {
  const cfg: InvitationConfig = {
    ...
    sections: [
      ...
      //   animation: "fadeIn",
      //   props: {
      //     title: "GIGGLING PLATYPUS",
      //     dateParts: { month: "MAY", day: "18", year: "2025" },
      ...
      //     infoText: "FOR MORE INFORMATION: WWW.REALLYGREATSITE.COM",
      //     illustration: "/events/poster/event-poster-bg-1.png",
      //   },
      // },
      // {
      ...
      //     background: "/events/background-images/event-bg-2.png",
      //   },
      // },
      // {
      //   type: "hero:event:retro",
      //   props: {
      //     background: "/events/background-images/event-bg-3.png",
      //     rsvpLine: "RSVP TO +123-456-7890",
      //     dateLine: "25 OCTOBER 2025",
      //     invitedLine: "(you are invited to)",
      //     bigTitle: "COCKTAIL PARTY",
      //     addressLine: "123 Anywhere St., Any City, ST 12345",
      //   },
      // },
      ...
      //   animation: "fadeIn",
      //   props: {
      //     background: "/birthdays/birthday-bg-1.png",
      //     subtitle: "LET’S DRINK TO OLIVIA’S 30TH",
      //     dateTime: "MAY 25, 2028 AT 9:30 PM",
      ...
      //   animation: "fadeIn",
      //   props: {
      //     background: "/birthdays/birthday-bg-cake-1.png",
      //     name: "Harper Russo",
      //     age: 18,
      //     subtitle: "PLEASE JOIN US IN CELEBRATION OF HARPER’S 18TH BIRTHDAY",
      //     date: "01.30.2030",
      //     address: "123 Anywhere St., Any City",
      //   },
      // },
      ...
      //   animation: "fadeIn",
      //   props: {
      //     title: "Arcane Birthday",
      //     subtitle: "You are invited",
      //     date: "Oct 25, 2025",
      //     time: "9:30 PM",
      //     venue: "Zaun Lounge",
      //     address: "123 Piltover Ave, Any City",
      //     rsvp: "RSVP: +123-456-7890",
      //     videoSrc: "/videos/arcane-animation.mp4",
      //     poster: "/videos/birthday-image.webp",
      //     duration: "0:24",
      //     ctaText: "RSVP",
      //   },
      // },
      ...
      //   animation: "fadeIn",
      //   props: {
      //     title: "EA Sports Birthday",
      //     subtitle: "Game On – You're Invited!",
      //     date: "Nov 15, 2025",
      //     time: "7:00 PM",
      //     venue: "Stadium Lounge",
      //     address: "99 Goal Street, Any City",
      //     rsvp: "RSVP: +123-456-7890",
      //     videoSrc: "/videos/fifa-edited-intro.mp4",
      //     poster: "/videos/fifa-birthday-poster.webp",
      //     duration: "0:45",
      ...
      // },
      {
        ...
        animation: "fadeIn",
        props: {
          title: "Fortnite Birthday Royale",
          subtitle: "Drop In – You're Invited!",
          date: "Dec 3, 2025",
          time: "8:00 PM",
          venue: "Battle Bus Lounge",
          address: "Victory Lane, Any City",
          rsvp: "RSVP: +123-456-7890",
          videoSrc: "/videos/fortnite-edited-intro.mp4",
          poster: "/videos/fortnite-birthday.webp",
          duration: "0:35",
          ctaText: "Drop In",
        },
      },
